...
const PROCESS_CPU_USER_SECONDS = 'process.cpu.user.seconds.total';
const PROCESS_CPU_SYSTEM_SECONDS = 'process.cpu.system.seconds.total';
const PROCESS_CPU_SECONDS = 'process.cpu.seconds.total';
