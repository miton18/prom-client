...
const NODEJS_HEAP_SIZE_TOTAL = 'nodejs.heap.size.total_bytes';
const NODEJS_HEAP_SIZE_USED = 'nodejs.heap.size.used_bytes';
const NODEJS_EXTERNAL_MEMORY = 'nodejs.external.memory.bytes';
